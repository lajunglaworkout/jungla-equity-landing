...
function initInfiniteScroll() {
  // Scroll snap está habilitado en CSS
  // Las secciones se abren SOLO al hacer click en el header
  console.log('📜 Scroll infinito activado - Las secciones se abren al hacer click');
}
